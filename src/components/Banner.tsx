...
export const Banner = ({ banner, img }: BannerProps) => {
    ...
    return (
        <section className="block mx-auto max-w-theme-wide my-40">
            <div className="relative my-10">
            <Link
                href=""
                className="absolute -top-24 left-3 right-3 lg:left-[50%] lg:translate-x-[-50%] bg-card text-card-foreground min-w-[370px] min-h-36 flex justify-center items-center flex-col gap-4 px-6 rounded-xl group"
            >
                ...
                <span className="text-primary group">
                    <span className="relative inline-block ml-3">
                        ...
                        <ArrowRightIcon className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] h-4 w-4 text-primary-foreground group-hover:card-foreground transition" />
                    </span>
